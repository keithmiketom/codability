...
class LearnsControllerTest < ActionController::TestCase
  ...
  test "should create learn" do
    assert_difference('Learn.count') do
      post :create, learn: { description: @learn.description, free: @learn.free, site: @learn.site, title: @learn.title }
    end
  ...
  test "should update learn" do
    put :update, id: @learn, learn: { description: @learn.description, free: @learn.free, site: @learn.site, title: @learn.title }
    assert_redirected_to learn_path(assigns(:learn))
  end
